"""Class-conditioned MobileNetV3 and EfficientNet models for defect classification."""
...
class ClassConditionedClassifier(nn.Module):
    """Shared backbone with class-guided spatial attention and FiLM conditioning."""
